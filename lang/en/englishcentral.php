...
$string['playerversiondefault'] = 'JSDK2';
$string['playerversionexplain'] = 'Generally you should use the most version available, but in some circumstances, you may wish to select an older version.';
