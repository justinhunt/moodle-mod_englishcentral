...
class englishcentral {
   ...
   * Set API URLS
   */
  //function accessTokenURL()  { return 'http://www.englishcentral.com/platform/accessToken'; }
  function accessTokenURL() { return 'http://www.englishcentral.com/platform/authenticate'; }
  function authenticateURL() { return 'http://www.englishcentral.com/platform/authenticate'; }
  function authorizeURL()    { return 'http://www.englishcentral.com/platform/authorize'; }
  function requestTokenURL() { return 'http://www.englishcentral.com/platform/requestToken'; }
