...
function xmldb_englishcentral_upgrade($oldversion) {
    ...
    // for demonstrative purposes and to show how the englishcentral
    // iself has been upgraded.

    // For each upgrade block, the file englishcentral/version.php
    ...
    if ($oldversion < 2007040100) {
        ...
        // Define field course to be added to englishcentral
        ...
        // Define field intro to be added to englishcentral
        $table = new xmldb_table('englishcentral');
        ...
        // Define field introformat to be added to englishcentral
        $table = new xmldb_table('englishcentral');
        ...
        upgrade_mod_savepoint(true, 2007040100, 'englishcentral');
    }
    ...
    if ($oldversion < 2007040101) {
        ...
        // Define field timemodified to be added to englishcentral
        $table = new xmldb_table('englishcentral');
        ...
        // Define index course (not unique) to be added to englishcentral
        $table = new xmldb_table('englishcentral');
        ...
        upgrade_mod_savepoint(true, 2007040101, 'englishcentral');
    }
    ...
    if ($oldversion < 2007040200) {
        ...
        upgrade_mod_savepoint(true, 2007040200, 'englishcentral');
    }
